...
const ThursdayCompleted = () => {
    ...
    socket.emit('room', 'thursday-completed')
    ...
    ////////////////////////////// SOCKET //////////////////////////////
    const sendUpdate = () => {
        socket.emit('send_update', {message: 'Successful update', room: 'thursday-completed'});
        setFetchData(true)
    }
...
export default ThursdayCompleted