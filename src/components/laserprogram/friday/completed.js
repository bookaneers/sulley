...
const FridayCompleted = () => {
    ...
    socket.emit('room', 'friday-completed')
    ...
    ////////////////////////////// SOCKET //////////////////////////////
    const sendUpdate = () => {
        socket.emit('send_update', {message: 'Successful update', room: 'friday-completed'});
        setFetchData(true)
    }
...
export default FridayCompleted