...
const WednesdayCompleted = () => {
    ...
    socket.emit('room', 'wednesday-completed')
    ...
    ////////////////////////////// SOCKET //////////////////////////////
    const sendUpdate = () => {
        socket.emit('send_update', {message: 'Successful update', room: 'wednesday-completed'});
        setFetchData(true)
    }
...
export default WednesdayCompleted