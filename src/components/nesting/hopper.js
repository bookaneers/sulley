...
import NestingPriority from './modals/priority'
import NestingActions from './modals/actions'
import NestingDispatch from './modals/dispatch'
                    ...
                    (item.status === "queue" ? 
                        <Row className={`display-row text-center ${item.typeOfCard}`} key={item._id}>
                            ...
                            <Col xs={1} className='display-col'>
                                {/* ==================== MODAL ==================== */}
                                    <NestingPriority item={item}/>
                                {/* ==================== END OF MODAL ==================== */}
                            </Col>
                            <Col xs={1} className='display-col'>
                                {/* ==================== MODAL ==================== */}
                                    <NestingDispatch item={item}/>
                                {/* ==================== END OF MODAL ==================== */}
                            </Col>
                            <Col xs={1} className='display-col'>
                                {/* ==================== MODAL ==================== */}
                                    <NestingActions item={item}/>
                                {/* ==================== END OF MODAL ==================== */}
                            </Col>
                        </Row> 
                    :null)
