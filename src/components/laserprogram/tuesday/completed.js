...
const TuesdayCompleted = () => {
    ...
    socket.emit('room', 'tuesday-completed')
    ...
    ////////////////////////////// SOCKET //////////////////////////////
    const sendUpdate = () => {
        socket.emit('send_update', {message: 'Successful update', room: 'tuesday-completed'});
        setFetchData(true)
    }
...
export default TuesdayCompleted